...
void UI::Initialize() {
	...
	texturesUI[2] = TextureManager::Load("uvChecker.png");
	texturesUI[3] = TextureManager::Load("debugfont.png");
	texturesUI[4] = TextureManager::Load("debugfont.png");
	texturesUI[5] = TextureManager::Load("debugfont.png");
	...
	uisprites_[2] =
	    Sprite::Create(texturesUI[2], {1200.0f, 700.0f}, {1.0f, 1.0f, 1.0f, 1.0f}, {0.5f, 0.5f});
	uisprites_[3] =
	...
	uisprites_[5] =
	    Sprite::Create(texturesUI[5], {1150.0f, 700.0f}, {1.0f, 1.0f, 1.0f, 1.0f}, {0.5f, 0.5f});
